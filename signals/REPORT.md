...
_Last update_: `2026-06-02 23:56 UTC`

## Latest signal

- **As-of close**: `2026-06-01 00:00:00` (close = `6.7662`)
- **Effective trading day**: `2026-06-02 00:00:00`
- **Composite signal**: `+0.5200`
- **Target position**: `+0.4000`  (LONG)
- **In market**: `True`
...
- **Signals recorded**: 4
- **Trading days observed**: 4 (since 2026-05-27)
