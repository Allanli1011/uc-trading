...
_Last update_: `2026-06-23 23:16 UTC`

## Latest signal

- **As-of close**: `2026-06-22 00:00:00` (close = `6.7686`)
- **Effective trading day**: `2026-06-23 00:00:00`
- **Composite signal**: `+0.9662`
- **Target position**: `+0.9577`  (LONG)
- **In market**: `True`
...
- **Signals recorded**: 16
- **Trading days observed**: 19 (since 2026-05-27)
